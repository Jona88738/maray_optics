    ...
    return(
        <>
            ...
            <section className="containerProducts">
                ...
                <section class="containerMainHome">
                    <article class="containerApartadoHomeVenta">
                        <div>
                    ...
                    <article class="containerApartadoHomeConsulta">
                        <div>
                    ...
                    <article class="containerApartadoHomeExpediente">
                        <div>
                    ...
                    <article class="containerApartadoHomeProducto">
                        <div>
