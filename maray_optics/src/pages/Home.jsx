    ...
    return(
        <>
            ...
            <section className="containerHome">
                ...
                <section className="containerMainHome">
                    <article className="containerApartadoHomeVenta">
                        <div>
                    ...
                    <article className="containerApartadoHomeConsulta">
                        <div>
                    ...
                    <article className="containerApartadoHomeExpediente">
                        <div>
                    ...
                    <article className="containerApartadoHomeProducto">
                        <div>
