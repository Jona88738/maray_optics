...
const Venta = () => {
  ...
  `,
    ...
    const totall = redondearMX(( datosTabla.reduce((acc, valorActual) => { return acc += valorActual.subtotal; }, 0)/ 100).toFixed(2) ) ;
    ...
    const handleChangeCantidad = (element, event) => {
     ...
     const handleChangeDescuento = (element, event) => {
        ...
        const nuevosDatos = datosTabla.map((elemento) => {
            const result = elemento.nombre === element.nombre ? true : false;
            console.log("Descuento:XD", value)
            console.log("element.descuento, ", elemento.descuento )
            if (result && elemento.descuento < parseInt(event.target.value)) {
                ...
                const descuentoPorcentaje = (value * (element.precio_venta * element.cantidad_compra)) / 100;
                ...
                elemento.subtotal = ((element.precio_venta * element.cantidad_compra) - descuentoPorcentaje) / 100;

                elemento.subtotal = elemento.subtotal * 100;
                console.log((element.precio_venta - descuentoPorcentaje) / 100, "Este es mi elemento Subtotal");

            } else if (result) {
                console.log("Entro")
                elemento.descuento = value;

                const descuentoPorcentaje = (value * element.precio_venta) / 100;
                ...
                console.log((elemento.subtotal / 100), "Este es mi elemento Subtotal");
    ...
    //     const nuevosDatos = datosTabla.map((elemento) => {
    //         const result = elemento.nombre === element.nombre ? true : false;
    //         console.log("Descuento:", descuento,"Valor: ", value)
    //         if (result && elemento.descuento < parseInt(event.target.value)) {
